...
.hero {
  ...
  z-index: 1;
  padding: 48px 6vw 32px;
  /* display: grid; unsupported in some MP, use flex or block */
  /* Uni-app view is block by default */
}
...
.timeline-track {
  ...
  flex-direction: row;
  gap: 32px;
  padding: 0 4vw 32px; /* Adaptive padding */
...
.timeline-item {
  ...
  vertical-align: top;
  margin-right: 0; /* Handled by flex gap in track if using view, but scroll-view usually needs inline-block margins */
}
/* Fix for scroll-view inline-block gap */
.timeline-item + .timeline-item {
  margin-left: 32px;
}
